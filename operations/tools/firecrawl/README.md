...
Any custom JSON extraction schemas, API response examples, or large data pulls from Firecrawl for Zendora's internal use should be saved in `operations/tools/firecrawl/data/`.
